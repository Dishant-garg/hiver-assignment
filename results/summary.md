...
- **Intent, agent vs logreg** (exact McNemar): agent alone correct on 59 rows, logreg alone correct on 14, p = 1.01e-07.
- **Intent, agent vs majority** (exact McNemar): agent alone correct on 107 rows, majority alone correct on 8, p = 3.07e-23.
...
- **Judged overall, agent minus nn** (n = 160): +0.406 [+0.113, +0.694]. Agent scored lower in 0% of resamples (higher score is better).
- **Judged overall, agent minus canned** (n = 40): +0.700 [+0.225, +1.175]. Agent scored lower in 0% of resamples (higher score is better).
